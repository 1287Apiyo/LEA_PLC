...
export const PROGRAMMES: Programme[] = [
  {
    ...
    curriculum: [
      { number: "01", title: "Digital foundations", weeks: "Weeks 1–2", summary: "Start with how the web works, the tools engineers use, and a reliable workflow for learning by doing.", topics: ["How the web works", "Developer tools", "Git & GitHub", "Learning workflow"], project: "Build an accessible LEA learner profile page and publish a short README explaining your choices." },
      { number: "02", title: "Frontend foundations", weeks: "Weeks 3–5", summary: "Turn ideas into clear, responsive interfaces that are structured for real people and real devices.", topics: ["Semantic HTML", "CSS layouts", "Responsive UI", "Accessibility"], project: "Build a responsive community services directory that works on a phone and desktop." },
      { number: "03", title: "JavaScript & interaction", weeks: "Weeks 6–8", summary: "Add behaviour to interfaces and learn how to reason through state, events, APIs, and bugs.", topics: ["Logic & data", "DOM & events", "Async APIs", "Debugging"], project: "Build a live conditions dashboard using a public weather API with loading, empty, and error states." },
      { number: "BREAK", title: "Mid-programme reset", weeks: "Week 9", summary: "Pause, review your progress, get mentor feedback, and return with a sharper plan for the backend build.", topics: ["Rest & reflection", "Portfolio check-in", "Mentor review"], project: "Complete a portfolio review, prioritised backlog, and mentor feedback record before the backend build.", type: "break" },
      { number: "04", title: "Backend & data", weeks: "Weeks 10–12", summary: "Build the systems behind a product: routes, data, authentication, validation, and secure services.", topics: ["Node & API routes", "Databases", "Authentication", "Validation"], project: "Build a learner enrolment REST API with courses, learners, progress records, validation, and endpoint tests." },
      { number: "05", title: "Full-stack integration", weeks: "Weeks 13–14", summary: "Connect the interface and backend into a complete product, then test and deploy it with confidence.", topics: ["Client-server flow", "Forms & state", "Testing", "Deployment"], project: "Build the LEA enrolment and payment simulator with M-Pesa-like pending, success, failure, cash, and admin states." },
      { number: "06", title: "Capstone & portfolio", weeks: "Weeks 15–16", summary: "Bring the full journey together in a guided capstone and shape a clear story around the work you made.", topics: ["Product scope", "Build sprint", "Demo day", "Portfolio story"], project: "Ship a community learning operations portal combining catalogue, enrolment, progress, payments, and an admin dashboard." },
    ],
    modules: [
  ...
  },
  {
    ...
    curriculum: [
      { number: "01", title: "AI in plain language", weeks: "Weeks 1–2", summary: "Build a useful mental model of modern AI systems, their strengths, limits, and everyday applications.", topics: ["AI vocabulary", "Models & data", "Use-case mapping", "Limits"], project: "Create an AI use-case map comparing a manual process, a rules-based tool, and an AI-assisted workflow." },
      { number: "02", title: "Prompt & workflow design", weeks: "Weeks 3–5", summary: "Turn repeated tasks into clearer, more reliable workflows that support research, writing, and decisions.", topics: ["Prompt structure", "Context design", "Reusable workflows", "Quality checks"], project: "Design an admissions or support workflow assistant that produces structured drafts and next actions from a fixed test set." },
      { number: "BREAK", title: "Studio reset", weeks: "Week 6", summary: "Step back from the tools, review what is working, and get feedback before moving into responsible practice.", topics: ["Rest & reflection", "Workflow review", "Mentor check-in"], project: "Audit the workflow, remove unnecessary automation, and document the revised human review step.", type: "break" },
      { number: "03", title: "Research & verification", weeks: "Weeks 7–8", summary: "Use AI to accelerate exploration without outsourcing judgement, accuracy, or the responsibility to verify.", topics: ["Research prompts", "Source checking", "Fact verification", "Decision notes"], project: "Produce a source-backed research brief with an evidence table, corrections log, and uncertainty notes." },
      { number: "04", title: "Responsible AI practice", weeks: "Weeks 9–10", summary: "Explore privacy, bias, safety, and the judgement needed to use intelligent tools with care.", topics: ["Privacy", "Bias & fairness", "Safety", "Human oversight"], project: "Review a fictional learner-support workflow for privacy, bias, unsafe decisions, and escalation requirements." },
      { number: "05", title: "Applied AI studio", weeks: "Weeks 11–12", summary: "Design, test, and present a small AI-supported project connected to a meaningful real-world outcome.", topics: ["Project brief", "Prototype", "Test & refine", "Showcase"], project: "Build a human-in-the-loop learner support assistant grounded in approved information with citations and escalation." },
    ],
    modules: [
  ...
  },
  {
    ...
    curriculum: [
      { number: "01", title: "Meet your computer", weeks: "Weeks 1–2", summary: "Learn the parts of a computer, how to use a mouse and keyboard, and how to work confidently with the desktop.", topics: ["Parts of a computer", "Mouse & keyboard", "Desktop basics", "Device care"], project: "Create and organise a personal digital workspace with folders, a backup copy, and a learner checklist." },
      { number: "02", title: "Files & documents", weeks: "Weeks 3–4", summary: "Create, save, find, and organise documents so your work stays easy to follow and share.", topics: ["Folders", "Documents", "Saving work", "Sharing"], project: "Create a useful community document pack with a flyer, simple budget, timetable, and shared folder." },
      { number: "BREAK", title: "Practice pause", weeks: "Week 5", summary: "Take a short pause to practise the essentials, ask questions, and celebrate the progress already made.", topics: ["Rest & practice", "Learner check-in", "Family support"], project: "Complete a digital confidence check-in and agree a supported next-step practice plan.", type: "break" },
      { number: "03", title: "Internet confidence", weeks: "Weeks 6–7", summary: "Search, communicate, and recognise safer online habits while building everyday digital independence.", topics: ["Search skills", "Email basics", "Online safety", "Digital kindness"], project: "Create a beginner-friendly safer online choices guide using real message and link scenarios." },
      { number: "04", title: "First digital project", weeks: "Week 8", summary: "Use new skills to make something simple, useful, and worth sharing with a mentor or family member.", topics: ["Choose an idea", "Make it", "Share it", "Next step"], project: "Make and present a small helpful digital product for a family, school, or community need." },
    ],
    modules: [
