  ...
  instructor: [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Grading Queue", href: "/instructor/grading", icon: Award },
        ...
        { title: "Tutor Sessions", href: "/instructor/tutor-sessions", icon: CalendarHeart },
        { title: "Discussions", href: "/instructor/discussions", icon: MessageSquare },
      ],
    },
  ],
  learner: [
    {
      ...
      items: [
        ...
        { title: "Discussions", href: "/learner/discussions", icon: MessageSquare },
        ...
        { title: "Tutor Sessions", href: "/learner/tutor-sessions", icon: CalendarHeart },
        { title: "Messages", href: "/learner/messages", icon: MessageSquare },
        { title: "Notifications", href: "/learner/notifications", icon: Bell },
    ...
    },
    {
      ...
      items: [
        ...
        { title: "Portfolio", href: "/learner/portfolio", icon: BriefcaseBusiness },
        { title: "Career Centre", href: "/learner/career", icon: GraduationCap },
        { title: "Preferences", href: "/learner/preferences", icon: Wrench },
        { title: "Achievements", href: "/learner/achievements", icon: Award },

        { title: "Progress", href: "/learner/progress", icon: BarChart3 },
        { title: "Learning analytics", href: "/learner/analytics", icon: BarChart3 },
