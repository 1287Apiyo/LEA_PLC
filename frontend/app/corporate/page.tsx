...
export default function CorporateTrainingPage() {
  return (
    <div className="min-h-screen overflow-hidden bg-[#fffdfb] text-[#17131a] selection:bg-[#f47945]/25">
      <LandingNav />
      <main>
        <section className="relative isolate min-h-[420px] overflow-hidden bg-[#351039] text-white sm:min-h-[460px] lg:min-h-[500px]">
          <div className="absolute inset-0 bg-cover bg-center saturate-[0.8]" style={{ backgroundImage: `url(${COLLABORATION_IMAGE})` }} />
          <div className="absolute inset-0 bg-[linear-gradient(135deg,rgba(35,72,111,0.72)_0%,rgba(77,23,110,0.76)_54%,rgba(244,121,69,0.24)_100%)] mix-blend-multiply" />
          <div className="absolute inset-0 bg-[#4d176e]/20" />
        ...
        <section className="bg-[#4d176e] px-5 py-10 text-white sm:px-10 sm:py-12 lg:px-[7vw] lg:py-16"><div className="mx-auto grid max-w-[1440px] gap-7 lg:grid-cols-[1fr_auto] lg:items-center"><div><h2 className="text-[clamp(1.9rem,3vw,3.1rem)] font-medium leading-[0.98] tracking-[-0.055em]">Ready to build capability that lasts?</h2><p className="mt-4 max-w-xl text-sm leading-6 text-white/70">Tell us what your team is working toward. We will help you shape a practical starting point.</p></div><Link href="/register" className="inline-flex w-fit items-center gap-3 bg-[#f47945] px-6 py-3 text-xs font-medium text-[#351039] transition hover:bg-[#ff8f57]">Start a conversation <ArrowRight className="h-4 w-4" /></Link></div></section>
      </main>
      <LandingFooter />
    </div>
  );
